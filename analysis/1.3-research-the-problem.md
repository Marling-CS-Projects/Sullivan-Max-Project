...
<figure><img src="../.gitbook/assets/image (1).png" alt=""><figcaption><p>The Left Mouse Button</p></figcaption></figure>
...
<figure><img src="../.gitbook/assets/image.png" alt=""><figcaption><p>The WASD Controls</p></figcaption></figure>
...
The game uses the keyboard to allow the character to move, with WASD but it also uses the mouse to allow the character to look around. For some situations in the game, the user may hav eto perform actions such as shooting a gun, which would require pressing the left mouse button.
