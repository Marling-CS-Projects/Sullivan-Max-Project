...
| Multiplayer | My game also requires ther being more than one player at a time                                                                   |
|             |                                                                                                                                   |
|             |                                                                                                                                   |
{% endtab %}
...
| Feature      | Justification                                                                                                        |
| ------------ | -------------------------------------------------------------------------------------------------------------------- |
| Levels       | My game will not need to utilize the level system since it is competition between two players                        |
| Gems         | My game is focused on beating the puzzle, and so there is no need for gems since they will bring nothing to my game. |
| Cooperative  | My game features players playing against each other, and so cooperative is not needed.                               |
| Platformer   | Fireboy and Watergirl is predominantly a platformer, where as I want my game to mainly be a puzzle game.             |
{% endtab %}
{% endtabs %}
