...
This has already been evidenced in [3.1](../testing/3.1-robustness.md#criterion-19-the-game-should-run-without-crashing), and from that and the testing in [3.2](../testing/3.2-usability-testing.md#error-tolerant) it is shown that the game crashing is not an issue for this game anymore and can run well consistently.
