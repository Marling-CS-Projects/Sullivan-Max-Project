...
The player can then use the teleporter to get to the coordinates shown. They can only do it once however there is the possiblity to move back down and thus be locked out. Because of this the following code was added.
