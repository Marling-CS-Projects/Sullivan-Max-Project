...
| 4    | A form after submitting these confirming if it was successful or if there was an error | A form where the user knows if their registration/login was successful and a lin to their next page                                                    | As expected                                                | Pass      |
